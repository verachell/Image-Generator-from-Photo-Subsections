...
This script is particularly well suited to modification for other purposes and use cases, for example extra image processing to add artistic effects and/or output of other dimensions of images. 
